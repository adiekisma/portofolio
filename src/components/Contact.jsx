            ...
            <div className='flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full'>
                ...
                <div className='flex justify-center items-center'>
                    <form action="" className='flex flex-col w-full md:w-1/2'>
                        ...
                        <button className='text-white bg-gradient-to-b from-cyan-400 to-blue-400 px-6 py-3 my-8 mx-auto flex items-center rounded-md hover:scale-150 duration-500'>Let's Talk</button>
                    </form>
                </div>
            </div>
        </div>
